        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('adminnxb.update', $nxb->MaNXB) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="TenNXB" name="TenNXB" value="{{ $nxb->TenNXB }}" class="form-control" required>
                              </div>
                          </div>
    
                            <div class="form-group row">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary">Cập Nhật NXB</button>
                                </div>
                            </div>
                        </form>
                    </div>
