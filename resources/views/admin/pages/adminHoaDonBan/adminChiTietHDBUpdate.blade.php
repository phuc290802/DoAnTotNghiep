            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3>Sửa chi tiết hóa đơn bán</h3>
                    </div>
    
                    <div class="card-body">
                        <form action="{{ route('adminchitietHDB.update', ['soHDB' => $chitietHDB->SoHDB, 'maSach' => $chitietHDB->MaSach]) }}" method="POST">
                            @csrf
                            @method('PUT')

  
                          <div class="form-group row">
                              <label for="SoLuongBan" class="col-md-4 col-form-label text-md-right">Số lượng bán</label>
                              <div class="col-md-6">
                                  <input type="text" id="SoLuongBan" name="SoLuongBan" value="{{ $chitietHDB->SoLuongBan }}" class="form-control" required>
                              </div>
                          </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="KhuyenMai" name="KhuyenMai" value="{{ $chitietHDB->KhuyenMai }}" class="form-control" required>
                                </div>
                            </div>
