        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('adminhdn.update', $hoadonnhap->SoHDN) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="MaNV" name="MaNV" value="{{ $hoadonnhap->MaNV }}" class="form-control" required>
                              </div>
                          </div>
  
                          <div class="form-group row">
                              <label for="MaNXB" class="col-md-4 col-form-label text-md-right">Mã Nhà xuất bản</label>
                              <div class="col-md-6">
                                  <input type="text" id="MaNXB" name="MaNXB" value="{{ $hoadonnhap->MaNXB }}" class="form-control" required>
                              </div>
                          </div>

                            <div class="form-group row">
                                <label for="NgayNhap" class="col-md-4 col-form-label text-md-right">Ngày Nhập</label>
                                <div class="col-md-6">
                                    <input type="text" id="NgayNhap" name="NgayNhap" value="{{ $hoadonnhap->NgayNhap }}" class="form-control" required>
                                </div>
                            </div>
